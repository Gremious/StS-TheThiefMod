...
public class StickyGloves extends CustomRelic {
    ...
    public static final String IMG = "defaultModResources/images/relics/StickyGloves.png";
    public static final String OUTLINE = "defaultModResources/images/relics/outline/StickyGloves.png";
