...
public class ThiefCardTags {
    ...
    public static AbstractCard.CardTags STEALING; // This card is a card that steals card.
    public static AbstractCard.CardTags STOLEN; // This card is a stolen card.
    public static AbstractCard.CardTags RARE_FIND; // This card is a stolen card.
