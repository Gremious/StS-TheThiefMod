...
public class DramaticFeignPower extends AbstractPower implements CanUsePower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("theThiefAssets/images/powers/84/DramaticFeignPower.png");
    private static final Texture tex32 = TextureLoader.getTexture("theThiefAssets/images/powers/32/DramaticFeignPower.png");
