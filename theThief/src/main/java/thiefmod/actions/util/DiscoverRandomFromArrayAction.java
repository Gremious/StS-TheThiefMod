...
public class DiscoverRandomFromArrayAction extends AbstractGameAction {
    ...
    private boolean freeForTurn = false;

    public DiscoverRandomFromArrayAction(final ArrayList<AbstractCard> cardList) {
        this(cardList, false, 3, false);
    }
    
    public DiscoverRandomFromArrayAction(final ArrayList<AbstractCard> cardList, boolean upgraded) {
        this(cardList, upgraded, 3, false);
    }
    
    public DiscoverRandomFromArrayAction(final ArrayList<AbstractCard> cardList, int amount) {
        this(cardList, false, amount, false);
    }
    
    public DiscoverRandomFromArrayAction(final ArrayList<AbstractCard> cardList, boolean upgraded, int amount, final boolean freeForTurn) {
