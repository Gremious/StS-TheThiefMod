...
public class ShadowMastery extends AbstractBackstabCard {
    ...
    public static final String IMG = "theThiefAssets/images/cards/beta/ShadowMastery.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new ShadowMasteryPower(p, p, magicNumber), magicNumber));
    }
