...
public class DissoluteSatisfaction extends AbstractBackstabCard {
    ...
    public static final String IMG = "theThiefAssets/images/cards/DissoluteSatisfaction.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new DissoluteSatisfactionPower(p, p, magicNumber), magicNumber));
    }
