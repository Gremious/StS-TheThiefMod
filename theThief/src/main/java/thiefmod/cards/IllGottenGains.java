...
public class IllGottenGains extends AbstractBackstabCard {
    ...
    public static final String IMG = "theThiefAssets/images/cards/IllGottenGains.png";
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new IllGottenGainsPower(p, magicNumber), magicNumber));
    }
