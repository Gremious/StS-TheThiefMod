...
public class ShadowClone extends AbstractBackstabCard {
    ...
    public static final String IMG = "theThiefAssets/images/cards/beta/ShadowClone.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new ShadowClonePower(p, p, magicNumber), magicNumber));
    }
