...
public class FindersKeepers extends AbstractBackstabCard {
    ...
    public static final String IMG = "theThiefAssets/images/cards/beta/FindersKeepers.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new FindersKeepersPower(p, p, magicNumber), magicNumber));
    }
