...
public class ShadowReserves extends AbstractBackstabCard implements ModalChoice.Callback {
    ...
    public static final String IMG = "theThiefAssets/images/cards/beta/ShadowReserves.png";
    ...
    public ShadowReserves() {
        ...
        modal = new ModalChoiceBuilder().setCallback(this) // Sets callback of all the below options to this
                ...
                .addOption("Fetch a card from your draw pile.", CardTarget.NONE).setColor(CardColor.COLORLESS) // Sets color of any following cards to green
                .addOption("Fetch a card from your discard pile.", CardTarget.NONE).setColor(CardColor.CURSE) // Sets color of any following cards to colorless
                .addOption("Fetch a card from your exhaust pile.", CardTarget.NONE).create();
    }
